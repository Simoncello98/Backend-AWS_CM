...
exports.CampusXCompanyConsistentUpdateManager = void 0;
...
var CampusXCompanyConsistentUpdateManager = /** @class */ (function (_super) {
    __extends(CampusXCompanyConsistentUpdateManager, _super);
    function CampusXCompanyConsistentUpdateManager() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    CampusXCompanyConsistentUpdateManager.getUniqueInstance = function () {
        if (!CampusXCompanyConsistentUpdateManager.obj)
            CampusXCompanyConsistentUpdateManager.obj = new CampusXCompanyConsistentUpdateManager();
        return this.obj;
    };
    //get all the given user's relatioships, active and not.
    CampusXCompanyConsistentUpdateManager.prototype.getRels = function (item) {
    ...
    CampusXCompanyConsistentUpdateManager.prototype.getUpdateObjects = function (rels, item, updateSchema) {
        var updateObjects = [];
    ...
    return CampusXCompanyConsistentUpdateManager;
}(ConsistentUpdateManagerClass_1.ConsistentUpdateManager));
exports.CampusXCompanyConsistentUpdateManager = CampusXCompanyConsistentUpdateManager;
