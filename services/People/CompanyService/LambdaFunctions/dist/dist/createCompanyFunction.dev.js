...
exports.createCompany = function (event, _context) {
      ...
      switch (_a.label) {
        case 0:
          ...
          if (!newCompany.enoughInfoForCreate() || newCompany.CompanyName === "*") {
            return [2
            /*return*/
            , Utils_1.Utils.getUniqueInstance().getValidationErrorResponse(requestBody, newCompany.getCreateExpectedBody())];
          }
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , dynamo.get(paramsGetRelationship).promise()];
        ...
        case 3:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_1, paramsGetRelationship)];
        ...
        case 4:
          ...
          if (errorResponseValidate.Error == "") {
            ...
            return [2
            /*return*/
            , Utils_1.Utils.getUniqueInstance().getErrorResponse(null, errorResponseValidate.Error, RestResultCodes_1.ISRestResultCodes.BadRequest)];
          }
        ...
        case 6:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getDataResponse(data)];

        case 7:
          error_2 = _a.sent();
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_2, params)];
