...
exports.uploadCompanyLogo = function (event, _context) {
      ...
      switch (_a.label) {
        case 0:
          ...
          if (!newLogo.enoughInfoForReadOrDelete()) {
            return [2
            /*return*/
            , Utils_1.Utils.getUniqueInstance().getValidationErrorResponse(requestBody, newLogo.getReadAndDeleteExpectedBody())];
          }
        ...
        case 2:
          ...
          return [4
          /*yield*/
          , dynamo.update(paramsUpdateDynamo).promise()];
        ...
        case 3:
          ...
          return [4
          /*yield*/
          , dynamo.query(paramsGetAllRelationships).promise()];

        case 4:
          dataRelationships = _a.sent();
          if (!(dataRelationships.Items.length > 0)) return [3
          /*break*/
          , 6];
          ...
          return [4
          /*yield*/
          , dynamo.transactWrite(paramsForTransact).promise()];
        ...
        case 6:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getDataResponse(responseData)];
        ...
        case 7:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_1, response)];
