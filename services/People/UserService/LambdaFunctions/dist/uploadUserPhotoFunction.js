...
exports.uploadUserPhoto = function (event, _context) { return __awaiter(void 0, void 0, void 0, function () {
    var requestBody, createPhoto, contentType, errorContentType, bucket, keyPathPrefix, key, s3, url, lengthURL, userToUpdate, buff, paramsPutS3, paramsUpdateUserPhoto, dynamo, dataUserPhoto, oldUser, paramsDeleteObjectS3, response, error_1, response;
        ...
        switch (_a.label) {
            case 0:
                ...
                if (!createPhoto.enoughInfoForReadOrDelete()) {
                    return [2 /*return*/, Utils_1.Utils.getUniqueInstance().getValidationErrorResponse(requestBody, createPhoto.getReadAndDeleteExpectedBody())];
                }
            ...
            case 2:
                _a.sent();
                return [4 /*yield*/, dynamo.update(paramsUpdateUserPhoto).promise()];
            case 3:
                dataUserPhoto = _a.sent();
                if (!(dataUserPhoto && dataUserPhoto.Attributes)) return [3 /*break*/, 5];
                oldUser = typescript_json_serializer_1.deserialize(dataUserPhoto.Attributes, User_1.User);
                if (!(oldUser && oldUser.UserPhoto)) return [3 /*break*/, 5];
                paramsDeleteObjectS3 = {
                    Bucket: bucket,
                    Key: oldUser.UserPhoto.substring(lengthURL)
                };
                return [4 /*yield*/, s3.deleteObject(paramsDeleteObjectS3).promise()];
            case 4:
                _a.sent();
                _a.label = 5;
            case 5:
