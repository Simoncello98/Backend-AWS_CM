...
exports.forceChangeEmail = function (event, _context) {
      ...
      switch (_g.label) {
        case 0:
          ...
          iotData = new aws_sdk_1.IotData({
            endpoint: Resources_1.Resources.IOTCoreEndpoint
          });
          CampusName = "";
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , Utils_1.Utils.getUniqueInstance().getEmailFromSignature(event.requestContext.identity.cognitoAuthenticationProvider, cognito)];
        ...
        case 3:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_1, {
            Error: {
        ...
        case 4:
          ...
          if (!requestedUpdateUser.enoughInfoForCreate()) {
            return [2
            /*return*/
            , Utils_1.Utils.getUniqueInstance().getValidationErrorResponse(requestBody, requestedUpdateUser.getCreateExpectedBody())];
          }

          createBadgeToTransact = [];
          deleteBadgeToTransact = [];
          temporaryPasswordFilled = requestedUpdateUser.SendEmail === "T" ? "" : Resources_1.Resources.DefaultPasswordForNewUsers;
        ...
        case 5:
          ...
          return [4
          /*yield*/
          , dynamo.get(paramForGetOldUser).promise()];

        case 6:
          dataGetOldUser = _g.sent();
          if (!dataGetOldUser.Item) return [3
          /*break*/
          , 66];
        ...
        case 7:
          ...
          return [4
          /*yield*/
          , dynamo.query(paramForUserCompanyRelationship).promise()];

        case 8:
          dataGetOldRelationship = _g.sent();
          if (!dataGetOldRelationship.Items) return [3
          /*break*/
          , 15];
          i = 0;
          _g.label = 9;
        ...
        case 9:
          if (!(i < dataGetOldRelationship.Items.length)) return [3
          /*break*/
          , 15];
        ...
        case 10:
          ...
          return [4
          /*yield*/
          , dynamo.query(paramsForDeleteBadge).promise()];
        ...
        case 12:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_2, paramsForDeleteBadge)];
        ...
        case 16:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_3, paramForUserCompanyRelationship)];
        ...
        case 18:
          ...
          return [4
          /*yield*/
          , dynamo.transactWrite(paramForTransact).promise()];
        ...
        case 20:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_4, paramForTransact)];

        case 21:
          cognitoParams = requestedUpdateUser.SendEmail === "T" ? UserServiceUtils_1.UserServiceUtils.getCognitoParams(requestedUpdateUser.NewUserEmail, Utils_1.Utils.getUniqueInstance().generateTemporaryPassword()) : UserServiceUtils_1.UserServiceUtils.getCognitoParamsWithoutSendingTheEmail(requestedUpdateUser.NewUserEmail, temporaryPasswordFilled);
        ...
        case 23:
          ...
          return [4
          /*yield*/
          , cognito.adminAddUserToGroup(cognitoGroupParams).promise()];
        ...
        case 25:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_5, response)];
        ...
        case 27:
          if (!(_b < createBadgeToTransact_1.length)) return [3
          /*break*/
          , 34];
          ...
          obj = __assign(__assign({}, badge.toJson(true)), {
            UserSerialID: userSerialIDMap.get(badge.CompanyName),
            Action: "Update"
          });
          iotParams = {
        ...
        case 28:
          ...
          return [4
          /*yield*/
          , dynamo.put(newBadgeParam).promise()];
        ...
        case 29:
          ...
          return [4
          /*yield*/
          , dynamo.put(badgeLogParams).promise()];
        ...
        case 30:
          ...
          return [4
          /*yield*/
          , iotData.publish(iotParams).promise()];
        ...
        case 32:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_6, mergedParams)];
        ...
        case 36:
          ...
          if (!(createLogsToTransact.length > 0)) return [3
          /*break*/
          , 40];
        ...
        case 37:
          ...
          return [4
          /*yield*/
          , dynamo.transactWrite(paramForTransactCreate).promise()];
        ...
        case 39:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_7, paramForTransactCreate)];
        ...
        case 41:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_8, params)];
        ...
        case 43:
          ...
          return [4
          /*yield*/
          , dynamo.get(mealParams).promise()];

        case 44:
          data = _g.sent();
          if (!data.Item) return [3
          /*break*/
          , 49];
        ...
        case 45:
          ...
          return [4
          /*yield*/
          , dynamo["delete"](mealParamsToDelete).promise()];
        ...
        case 46:
          ...
          return [4
          /*yield*/
          , dynamo.put(mealParamsToCreate).promise()];
        ...
        case 48:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_9, response)];
        ...
        case 50:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_10, mealParams)];
        ...
        case 52:
          if (!(_f < deleteBadgeToTransact_1.length)) return [3
          /*break*/
          , 58];
        ...
        case 53:
          ...
          return [4
          /*yield*/
          , dynamo["delete"](deleteBadgeParam).promise()];
        ...
        case 56:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_11, mergedParams)];
        ...
        case 59:
          ...
          return [4
          /*yield*/
          , dynamo.transactWrite(paramForTransactDelete).promise()];
        ...
        case 61:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_12, paramForTransactDelete)];
        ...
        case 63:
          ...
          return [4
          /*yield*/
          , cognito.adminDeleteUser(paramsCognitoDeleteUser).promise()];
        ...
        case 65:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_13, response)];
        ...
        case 67:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_14, paramForGetOldUser)];

        case 68:
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getDataResponse({
            Message: "OK",
            Password: temporaryPasswordFilled
          })];
      }
    });
  });
