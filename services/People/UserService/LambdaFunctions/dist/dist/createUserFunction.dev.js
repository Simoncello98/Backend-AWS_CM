...
exports.createUser = function (event, _context) {
      ...
      switch (_a.label) {
        case 0:
          ...
          if (!newUser.enoughInfoForCreate()) {
            return [2
            /*return*/
            , Utils_1.Utils.getUniqueInstance().getValidationErrorResponse(requestBody, newUser.getCreateExpectedBody())];
          } //Validate
          ...
          if (newUser.Email) {
            ...
            if (error) {
              ...
              , Utils_1.Utils.getUniqueInstance().getErrorResponse(null, {
                Error: {
                  Message: "An error occurred when try to fill standard email."
                }
              }, ISRestResultCodes_1.ISRestResultCodes.BadRequest)];
            }
        ...
        case 1:
          ...
          return [4
          /*yield*/
          , dynamo.get(paramsDisabledUser).promise()];
        ...
        case 2:
          ...
          if (!dataDisabledUser.Item) return [3
          /*break*/
          , 4];
          return [4
          /*yield*/
          , cognito.adminEnableUser(paramsCognitoIdentityGetUser).promise()];
        ...
        case 5:
          ...
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_1, {
            paramsDisabledUser: paramsDisabledUser
          })];
        ...
        case 6:
          ...
          if (newUser.TelephoneNumber) {
            if (!newUser.TelephoneNumber.match(/^\+?(\d\s?)*\d$/g)) {
              ...
              , Utils_1.Utils.getUniqueInstance().getErrorResponse(null, {
                Error: {
                  message: "Invalid Thelephone number!"
                }
              }, ISRestResultCodes_1.ISRestResultCodes.BadRequest)];
            }
          }
        ...
        case 8:
          ...
          return [4
          /*yield*/
          , cognito.adminCreateUser(paramsForCreateUserInCognito).promise()];

        case 9:
          cognitoCreateUserData = _a.sent();
          return [4
          /*yield*/
          , cognito.adminAddUserToGroup(cognitoAssociateGroupParams).promise()];

        case 10:
          cognitoAssociateGroupData = _a.sent();
          result = __assign(__assign(__assign(__assign({}, cognitoCreateUserData), cognitoAssociateGroupData), data), {
            Email: newUser.Email,
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getDataResponse(result)];
        ...
        case 11:
          ...
          return [2
          /*return*/
          , Utils_1.Utils.getUniqueInstance().getErrorResponse(error_2, mergedParams)];
