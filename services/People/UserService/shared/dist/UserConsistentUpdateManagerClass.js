...
var UserConsistentUpdateManager = /** @class */ (function (_super) {
    ...
    UserConsistentUpdateManager.getUniqueInstance = function () {
        if (!UserConsistentUpdateManager.obj)
            UserConsistentUpdateManager.obj = new UserConsistentUpdateManager();
        return this.obj;
    };
