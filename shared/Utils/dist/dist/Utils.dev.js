...
function () {
  ...
  Utils.prototype.getDataResponse = function (data) {
    ...
    if (_typeof(data) === "object") {
      ...
      if (dataResponse.errorType != undefined) response.body = dataResponse.errorMessage;else response.body = JSON.stringify(data);
    } else response.statusCode = RestResultCodes_1.ISRestResultCodes.NotFound;
  ...
  Utils.prototype.getErrorResponse = function (errorBody, params, errorCode) {
    if (errorCode === void 0) {
      errorCode = RestResultCodes_1.ISRestResultCodes.Error;
    }
  ...
  Utils.prototype.getResponse = function (statusCode, body) {
    ...
    response.headers = {
      ...
      "Access-Control-Allow-Methods": "OPTIONS,POST,GET,PUT,DELETE" //TODO you probably need to add : "Access-Control-Allow-Credentials" : true
  ...
  Utils.prototype.validateRequestObject = function (event) {
    ...
    if (!event.body && !event.queryStringParameters) {
      //lambda direct calls and step functions payload has no body and no queryStringParameters.
      if (typeof event == "string") bodyString = event; //step functions
      else if (_typeof(event) == "object") bodyString = JSON.stringify(event); //lambda direct call has object payload.
        else return {}; //nothing received.
    } else if (event.body != undefined) bodyString = event.body;else if (event.queryStringParameters != undefined) bodyString = this.getObjectStringFromDictionary(event.queryStringParameters);
  ...
  Utils.prototype.recursivelyGetUpdateExpression = function (item, parentPath, parentValuePath, expression) {
    ...
    for (var index in sourceKeysArray) {
      ...
      if (_typeof(value) != "object" || Array.isArray(value)) {
        //this object attributes - base recursive case
  ...
  Utils.prototype.recursivelySetUpdatedKeysForSameSchema = function (actualBaseItem, itemToUpdate) {
    ...
    for (var index in sourceKeysArray) {
      ...
      if (_typeof(value) != "object" && value != undefined || Array.isArray(value)) {
        //this object attributes - base recursive case
  ...
  Utils.prototype.recursivelySetUpdatedKeysForSchema = function (schema, actualBaseItem, itemToUpdate) {
    for (var baseItemKey in schema) {
      ...
      var baseValue = actualBaseItem[baseItemKey]; //this if is inverted because if we found a defined attribute in the top level object, we can say that at least one is defined and don't check in nested childs. 

      if (_typeof(baseValue) != "object" && baseValue != undefined || Array.isArray(baseValue)) {
        //this object attributes - base recursive case
        //change prop in the objToUpdate
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , cognito.adminGetUser(cognitoParams).promise()];

          case 2:
            cognitoData = _a.sent();
            return [2
            /*return*/
            , cognitoData.UserAttributes.find(function (item) {
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , cognito.adminListGroupsForUser(cognitoParams).promise()];

          case 2:
            cognitoData = _a.sent();
            return [2
            /*return*/
            , cognitoData.Groups[0].GroupName];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [4
            /*yield*/
            , dynamo.query(companiesAdminParams).promise()];

          case 2:
            companiesAdminData = _a.sent();
            return [2
            /*return*/
            , companiesAdminData.Items];
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4
            /*yield*/
            , s3.listObjectsV2(paramsToListObjects).promise()];
          ...
          case 1:
            ...
            listObjects.Contents.forEach(function (_a) {
              var Key = _a.Key;
              paramsToDelete.Delete.Objects.push({
                Key: Key
              });
            });
            return [4
            /*yield*/
            , s3.deleteObjects(paramsToDelete).promise()];

          case 2:
            _a.sent();

            if (!listObjects.IsTruncated) return [3
            /*break*/
            , 4];
            return [4
            /*yield*/
            , this.emptyBucket(prefix, s3)];
