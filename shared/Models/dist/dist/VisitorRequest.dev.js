...
function (_super) {
  ...
  VisitorRequest.prototype.autoFillUndefinedImportantAttributes = function () {
    ...
    if (!this.VisitorRequestStatus) this.VisitorRequestStatus = VisitorRequestStatus_1.VisitorRequestStatus.PENDING;
  ...
  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "CampusName");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "VisitorEmail");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "VisitorRequestID");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "UserHostEmail");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "UserHostTelephoneNumber");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "UserHostCompanyName");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "VisitorTelephoneNumber");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "EstimatedDateOfArrival");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "EstimatedReleaseDate");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "RequestTimestamp");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "VisitorRequestStatus");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "VisitorFName");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "VisitorLName");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "UserHostFName");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "UserHostLName");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "GSI2PK");

  __decorate([typescript_json_serializer_1.JsonProperty()], VisitorRequest.prototype, "GSI2SK");

  VisitorRequest = __decorate([typescript_json_serializer_1.Serializable()], VisitorRequest);
